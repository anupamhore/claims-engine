...
WHY: Track and version database schema changes
  - Reproducible schema deployment
  - Easy rollback if changes break things
  - Team collaboration on schema changes
  - Audit trail of what changed

HOW:
  - Auto-generate migrations from SQLAlchemy models
  - Manual migration editing if needed
...
# Set sqlalchemy.url to use our DATABASE_URL
